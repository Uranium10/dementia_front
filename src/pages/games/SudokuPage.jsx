        ...
        <div className="fixed inset-0 bg-[#2C3E50]/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-[2rem] p-8 max-w-sm w-full shadow-2xl flex flex-col items-center text-center">
            ...
            <div className="w-full flex flex-col gap-3">
              ...
              <button onClick={() => navigate('/game-stats?tab=puzzle')} className="w-full bg-slate-100 text-[#34495E] font-black text-xl py-4 rounded-full border-2 border-slate-200 active:scale-95 transition-all hover:bg-slate-200">통계 확인하기</button>
